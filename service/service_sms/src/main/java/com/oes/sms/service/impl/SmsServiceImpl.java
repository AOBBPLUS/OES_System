package com.oes.sms.service.impl;

import com.oes.sms.service.SmsService;
import com.oes.sms.utils.ConstantPropertiesUtils;
...
public class SmsServiceImpl implements SmsService {
    ...
    public boolean sendVerificationCode(String phone, String[] params) {
        try {
            ...
            httpProfile.setEndpoint(ConstantPropertiesUtils.END_POINT);
